...
<body> 
	...
	<div class="header">
		<div class="logo">
			<a href="index.html"><img src="images/logo.png" alt="" class="img-circle" height="100px" width="150px"></a>
		</div>
			...
			<div class="header-bottom">
				<div class="h_menu4"><!-- start h_menu4 -->
					...
					<ul class="nav">
						...
						<li><a href="product.html">Giới thiệu</a>	
						</li>
		...
		<!-- <div class="container-fluid"> -->
			...
			<div class="content">
				...
				<div class="content-grids">
					...
					<!-- <div class="col-md-10">
						 <div class="jumbotron1 col-md-12">
						 	<div id="jum1">
						 	 	<center><B>SẢN PHẨM MỚI NHẤT</B></center>
						 	 </div> 
						 	<div>
						 		<img src="images/pic.jpg" alt="" class="img-rounded">
						 	</div>
		...
		<div class="footer">
			...
			<div class="col-md-4 footer-left left-footer">
				...
				<div class="letter run-top">
					...
					<p class="footer-class"> © 2018 Shoe All Rights Reserved | Template by T-5 </p>
				</div>
